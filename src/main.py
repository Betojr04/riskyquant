...
from analysis.var import calculate_var, calculate_daily_returns, calculate_cvar, backtest_var
    ...
    if data_type.lower() == 'historical':
        ...
        if historical_data is not None:
            ...
            if daily_returns is not None:
                ...
                print(f"\n1-day 95% VaR: {var}")
                # Backtesting
                exceedance_rate = backtest_var(daily_returns, var)
                print(f"Backtesting exceedance rate: {exceedance_rate:.2%}")
